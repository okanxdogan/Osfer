...
import { User, Calendar, BookOpen, Clock, Link as LinkIcon, Settings, ChevronLeft, ChevronRight, BookMarked, Quote, Map, CalendarDays } from 'lucide-react';
...
const navItems = [
  ...
  { icon: Quote, label: 'Wisdom', href: '/wisdom' },
